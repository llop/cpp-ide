...
function gdbMI( command_and_args, options, gdbWrapper )
{
  ...
  for (var x in this.wrapper.gdb_instance) {
    console.log(x + " = " + this.wrapper.gdb_instance[x]);
}
console.log("asdasd" + this.wrapper.gdb_instance.stdin);
console.log("asdasasasdasdd" + this.wrapper.gdb_instance.stdout);
